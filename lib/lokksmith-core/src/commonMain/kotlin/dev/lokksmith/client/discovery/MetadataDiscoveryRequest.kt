 ...
 * @see <a href="https://www.rfc-editor.org/rfc/rfc8414">OAuth 2.0 Authorization Server Metadata
 *   (RFC 8414)</a>
 */
public interface MetadataDiscoveryRequest {

    /**
     * Reads configuration from a ".well-known" URI like `/.well-known/openid-configuration` or
     * `/.well-known/oauth-authorization-server`
     */
    public suspend operator fun invoke(url: String): Client.Metadata
}

internal class MetadataDiscoveryRequestImpl(private val httpClient: HttpClient) :
