...
private fun ClientSection(
    ...
    var clientId by remember { mutableStateOf("pennyandroid") }
    var discoveryUrl by remember { mutableStateOf("https://account.pre.penny.de/realms/penny/.well-known/openid-configuration") }
...
private fun FlowsSection(
    ...
    var codeFlowRedirectUri by remember { mutableStateOf("penny-auth://login-success") }
    var endSessionRedirectUri by remember { mutableStateOf("penny-auth://logout-success") }
